...
# Load dataset
advertising_data <- read.csv("media_13.csv")
...
# Try It Out #1: Add a caption and consistent theme
# Add a caption using labs(caption = "...")
# Try different themes like theme_bw() or theme_light()
# Customize font sizes or colors using theme()
# Hint:Use theme() parameters like plot.caption, axis.text, axis.title.
