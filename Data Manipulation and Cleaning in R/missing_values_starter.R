...
retail_data <- read_csv("retail_set9.csv")  # read_csv() from the readr package reads the CSV file into a data frame.
...
complete_orderdate_cases <- retail_data[______________(retail_data$__________), ]  
